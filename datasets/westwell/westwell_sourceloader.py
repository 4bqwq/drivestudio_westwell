...
# Westwell Camera List (5 cameras):
# 0: CAM_FRONT_MID
# 1: CAM_FRONT_LEFT
# 2: CAM_FRONT_RIGHT
# 3: CAM_REAR_LEFT
...
class WestwellCameraData(CameraData):
    ...
    def load_calibrations(self):
        ...
        # Load the first camera (front mid) pose to align the world
...
class WestwellPixelSource(ScenePixelSource):
    def __init__(
        self,
        dataset_name: str,
    ...
    def load_objects(self):
        ...
        if self.data_cfg.load_smpl:
            ...
            for cam_id in self.camera_list:
                cam_to_worlds[cam_id] = WestwellCameraData.get_camera2worlds(
                    self.data_path,
                    str(cam_id),
                    self.start_timestep,
                    self.end_timestep
...
class WestwellLiDARSource(SceneLidarSource):
    def __init__(
        self,
